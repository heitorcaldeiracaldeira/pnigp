...
> Gerada em 2026-08-13 07:04 -03 por `scripts/gerar_documentacao.mjs`. Reflete o estado real do código e do banco. **Não editar à mão.**
...
| `arquivo_texto_sc` | 650.386 | 17 (cnpj, ano, seq, sequencial_documento, cod_ibge, tipo_documento, titulo, texto…) |
| `arquivos_proc_feitos` | 249.402 | 3 (numero_controle, n, feito_em) |
| `arquivos_sc` | 654.734 | 14 (cnpj, ano, seq, sequencial_documento, cod_ibge, tipo_documento_id, tipo_documento, titulo…) |
...
| `catalogo_govbr_sc` | 23.564 | 7 (nivel, tipo, cod, nome, classe, grupo, atualizado_em) |
...
| `coleta_incremental_log` | 22 | 9 (rodada_em, uf, janela_ini, janela_fim, vistos, mudaram, iguais, novos…) |
...
| `contratacao_disputa_sc` | 993 | 10 (cod_ibge, cnpj, ano, seq, n_licitantes, n_lances, n_itens_marca, atualizado…) |
| `contratacoes` | 1.035 | 13 (id, ente_tipo, ente_id, numero, objeto, orgao, modalidade, valor_estimado…) |
| `contratacoes_sc` | 249.402 | 35 (cod_ibge, cnpj, ano, seq, esfera, plataforma, modalidade_id, modalidade…) |
| `contrato_sc` | 10.559 | 30 (cnpj, ano, seq, cod_ibge, uf, municipio_nome, numero_controle_pncp, numero_controle_compra…) |
| `contratos_sc` | 2.355.819 | 14 (id, cod_ibge, numero_controle_compra, cnpj_compra, ano_compra, seq_compra, fornecedor, ni_fornecedor…) |
...
| `crp_alertas` | 561 | 11 (id, cod_ibge, nome, eh_estado, evento, categoria_de, categoria_para, dias…) |
...
| `erp_portal_municipal` | 904 | 6 (cod_ibge, erp, slug, url, titulo, achado_em) |
...
| `folha_elotech_coleta` | 120 | 10 (slug, entidade_id, cod_ibge, municipio, uf, exercicio, linhas, situacao…) |
| `folha_empenho_rs` | 1.071.169 | 15 (ano, mes, ente, secretaria, unidade, elemento, rubrica, credor…) |
| `folha_epublica_coleta` | 19 | 8 (cod_ibge, municipio, uf, competencia, linhas, situacao, detalhe, em) |
| `folha_geosiap_coleta` | 30 | 8 (cod_ibge, municipio, uf, competencia, linhas, situacao, detalhe, em) |
| `folha_ipm_coleta` | 262 | 8 (cod_ibge, municipio, uf, competencia, linhas, situacao, detalhe, em) |
| `folha_megasoft_coleta` | 75 | 9 (slug, cod_ibge, municipio, uf, competencia, linhas, situacao, detalhe…) |
| `folha_portaltp_coleta` | 112 | 8 (cod_ibge, municipio, uf, competencia, linhas, situacao, detalhe, em) |
...
| `folha_servidores_betha` | 167.261 | 18 (cod_ibge, municipio, uf, entidade, competencia, nome, cargo, classificacao_cargo…) |
| `folha_servidores_cr2` | 53.975 | 21 (foff_id, entidade, cod_ibge, municipio, uf, competencia, matricula, cpf_masc…) |
| `folha_servidores_elotech` | 1.351 | 20 (cod_ibge, municipio, uf, slug, entidade_id, entidade, exercicio, matricula…) |
| `folha_servidores_epublica` | 35.066 | 24 (cod_ibge, municipio, uf, unidade_gestora, competencia, nome, cpf_masc, matricula…) |
| `folha_servidores_geosiap` | 1.468 | 18 (cod_ibge, municipio, uf, entidade, competencia, cpf_masc, chapa, nome…) |
| `folha_servidores_ipm` | 278.901 | 18 (cod_ibge, municipio, uf, entidade, competencia, nome, cargo, lotacao…) |
| `folha_servidores_ma` | 324.452 | 24 (ano, mes, cnpj, ente_id, ente, unidade, poder, matricula…) |
| `folha_servidores_megasoft` | 41.813 | 20 (cod_ibge, municipio, uf, slug, competencia, matricula, nome, cpf_masc…) |
| `folha_servidores_pe` | 434.615 | 20 (exercicio, uj_codigo, uj_nome, municipio_cod, municipio, natureza_orgao, nome, cpf_masc…) |
| `folha_servidores_portaltp` | 4.035 | 28 (cod_ibge, municipio, uf, unidade_gestora, competencia, nome, cpf_masc, matricula…) |
| `folha_servidores_sc` | 4.856.950 | 16 (anomes, cod_ibge, municipio, orgao, poder, lotacao, cargo, tipo_cargo…) |
| `frescor_log` | 36 | 6 (id, rodado_em, total, ok, resumo, problemas) |
...
| `item_apresentacao_desc_sc` | 47.914 | 7 (chave, unidade_basica, fator, conf, metodo, n_itens, atualizado) |
| `item_apresentacao_sc` | 3.053 | 9 (unidade, unidade_basica, fator, forma, dimensao, conf, metodo, n_itens…) |
...
| `item_marca_sc` | 12.127 | 12 (cod_ibge, cnpj, ano, seq, numero, descricao, produto_ata, modelo…) |
...
| `item_resultado_sc` | 1.695.994 | 23 (cod_ibge, cnpj, ano, seq, numero, sequencial_resultado, ni_fornecedor, nome_razao_social_fornecedor…) |
| `itens_classificacao_sc` | 406.000 | 14 (descr_norm, tipo, cat_nivel, cat_cod, cat_nome, cat_classe, shared, cobertura…) |
| `itens_proc_feitos` | 249.370 | 4 (numero_controle, n, feito_em, versao) |
| `itens_sc` | 2.275.577 | 49 (cod_ibge, cnpj, ano, seq, numero, descricao, unidade, quantidade…) |
...
| `marca_ata_feitas` | 37.889 | 6 (cnpj, ano, seq, n_marcas, feito_em, n_propostas) |
| `marca_tpl_feitas` | 147.755 | 5 (cnpj, ano, seq, n_marca, feito_em) |
...
| `notificacao_impacto` | 288 | 7 (id, cod_ibge, alerta_id, tipo_impacto, valor, descricao, registrado_em) |
| `notificacao_log` | 5.886 | 11 (id, cod_ibge, alerta_id, chave_delta, destinatario_id, canal, severidade, enviado_em…) |
...
| `pg_stat_statements` | 1.655 | 52 (userid, dbid, toplevel, queryid, query, plans, total_plan_time, min_plan_time…) |
...
| `pncp_evento` | 112.039 | 22 (cnpj, ano, seq, cod_ibge, categoria, acao, item_numero, resultado_sequencial…) |
...
| `precatorios_entes_sc` | 298 | 7 (cd_entidade, de_entidade, cod_ibge, regime, valor, qtde, atualizado) |
| `precatorios_sc` | 241 | 5 (cod_ibge, total_valor, total_qtde, n_entes, atualizado) |
...
| `processos_sc` | 249.402 | 11 (cnpj_orgao, ano, sequencial, cod_ibge, numero_controle, modalidade_id, modalidade, objeto…) |
...
| `rpps_crp_sc` | 14.373 | 9 (cod_ibge, nr_cnpj_entidade, no_ente, sg_uf, nr_crp, ds_situacao, tp_crp, dt_emissao…) |
...
| `vw_folha_municipal_brasil` | 15.959.164 | 14 (fonte, natureza, uf, competencia, cod_ibge, municipio, orgao, secretaria…) |
| `vw_folha_municipal_sc` | 3.947.073 | 14 (anomes, cod_ibge, municipio, orgao, poder, lotacao_origem, area, cargo…) |
| `vw_folha_municipio_qualidade` | 7.565 | 9 (fonte, uf, cod_ibge, municipio, linhas, tem_cargo, tem_salario, tem_secretaria…) |
| `vw_folha_oficial` | 4.873.401 | 14 (fonte, natureza, uf, competencia, cod_ibge, municipio, orgao, secretaria…) |
...
|---|---|---|---|---|
| Outorgas de uso da água por município (ANA, finalidade+série) | ana | — | há 4d | em dia |
| Barragens por município (ANA/SNISB — dano potencial + risco) | ana | 2025 | há 20h | em dia |
| Banda larga fixa por município (ANATEL, série 2007+) | anatel | — | há 20h | em dia |
| Geração distribuída de energia por município (ANEEL, série) | aneel | — | há 20h | em dia |
| CFEM — royalties de mineração por município (ANM, distribuição) | anm | 2026 | há 4d | em dia |
| Preços de combustíveis por município (ANP, semestral, série 2004+) | anp | 2021 | há 4d | em dia |
| Vendas de combustíveis por município (ANP, série 1990+) | anp | 2024 | há 20h | em dia |
| Cobertura de planos de saúde por município (ANS — pressão sobre o SUS) | ans | 2026 | há 4d | em dia |
| CMED/Anvisa PMVG — preço-teto legal de medicamentos (Conformidade Gov, auto-descobre URL); referência nacional p/ sobrepreço em saúde (SC = ICMS 17%) | anvisa | 2025 | há 9d | em dia |
| Desastres S2ID por município (Atlas Digital CEPED-UFSC/MIDR, série 1991+) | atlas | — | há 20h | em dia |
| IDHM + subíndices por município (Atlas Brasil PNUD, Censo 2010) | atlasbrasil | 2025 | há 4d | em dia |
| Sistema financeiro por município (BCB Olinda — agências/cooperativas/correspondentes + Pix série) | bcb | — | há 9d | em dia |
| ESTBAN — volumes bancários por município (BCB, crédito/poupança, série) | bcb | — | há 9d | em dia |
| PRONAF / Crédito Rural por município — valor contratado por ano (BCB SICOR/Matriz do Crédito Rural, OData; cdEstado=25) | bcb | 2025 | há 4h | em dia |
| BNDES desembolsos por município (crédito produtivo, série 1995+) | bndes | 2026 | há 4d | em dia |
| Espelho completo CADPREV (37 recursos: DAIR/DIPR/DRAA/RPPS_*) | cadprev | — | há 16d | em dia |
| Alertas de CRP (transições vencido/a vencer — varredura) | cadprev | — | há 20h | em dia |
| Déficit atuarial RPPS (CADPREV/DRAA) | cadprev | — | há 20h | em dia |
| Regularidade previdenciária CRP (CADPREV — Consulta Pública) | cadprev | — | há 20h | em dia |
| Equipamentos SUAS — fallback de geo por CEP (AwesomeAPI) | cadsuas | — | há 1h | pendente |
| Equipamentos SUAS — endereço/telefone (CadSUAS detalhe, HTTP) | cadsuas | — | há 20h | em dia |
| Equipamentos SUAS — geocodificação (Nominatim/OSM por endereço) | cadsuas | — | há 20h | em dia |
| Equipamentos SUAS por unidade (CadSUAS, Playwright): CRAS/CREAS/Centro POP/Acolhimento + nome/nº | cadsuas | — | há 20h | em dia |
| Estações de monitoramento de risco CEMADEN por município (defesa civil) | cemaden | 2025 | há 20h | em dia |
| Transferências (CGU) | cgu | — | há 20h | em dia |
| Transferências federais à prefeitura (CGU download em massa) | cgu | 2025 | há 20h | em dia |
...
| Saneamento SINISA por município (água/esgoto/resíduos, Min. Cidades, ref 2024) | cidades | 2024 | há 4d | em dia |
| CNES — rede de saúde (Min. Saúde) | cnes | 2026 | há 20h | em dia |
| Unidades de conservação por município (MMA CNUC, interseção PostGIS) | cnuc | — | há 4d | em dia |
| Catálogo oficial CATMAT/CATSER (Compras.gov.br) — espinha de classificação | compras | — | há 20h | em dia |
| Referência NACIONAL de preços por CATMAT (Painel de Preços/Compras.gov.br), por unidade e por forma (avulso×escala) — enriquece o Banco de Preços e o sobrepreço | compras | 2025 | há 1h | pendente |
| PAA compras agricultura familiar por município (Conab) | conab | 2025 | há 20h | em dia |
| Bancada federal do estado (deputados + senadores) p/ módulo de Captação de Emendas — APIs Câmara + Senado | congresso | 2025 | há 9d | em dia |
| Lei Paulo Gustavo execução/saldo por município (MinC) | cultura | 2025 | há 20h | em dia |
| Comunidades quilombolas certificadas por município (Palmares) | cultura | — | há 20h | em dia |
| Lei Rouanet SALIC — aprovado/captado por município (MinC) | cultura | 2025 | há 6d | em dia |
| APAC oncologia e diálise por município (SIA-APAC) | datasus | — | há 20h | em dia |
| Equipamentos médicos por estabelecimento (CNES EQ) | datasus | 2024 | há 4d | em dia |
| Equipes de saúde (ESF) por município/estabelecimento (CNES EP) | datasus | 2024 | há 4d | em dia |
| Estabelecimentos de saúde por município (CNES — rede p/ regulação, API DEMAS) | datasus | 2025 | há 20h | em dia |
| Leitos hospitalares por estabelecimento (CNES LT) | datasus | 2024 | há 4d | em dia |
| Profissionais de saúde por município/estabelecimento (CNES PF) | datasus | 2024 | há 38d | em dia |
| Medicamentos de alto custo CEAF por município (SIA grupo 06) | datasus | — | há 20h | em dia |
| Previne Brasil — indicadores APS (SISAB) | datasus | — | há 9d | em dia |
| Saúde mental CAPS/RAAS por município (SIA-RAAS-PS) | datasus | — | há 20h | em dia |
| SIA — produção ambulatorial (DATASUS) | datasus | 2025 | há 20h | em dia |
| Produção ambulatorial SUS por complexidade (DATASUS SIA + SIGTAP) | datasus | — | há 4d | em dia |
| Internações SUS por município (DATASUS SIH DBC mensal) | datasus | 2024 | há 4d | em dia |
| SIH — produção hospitalar (DATASUS TabNet) | datasus | 2025 | há 20h | em dia |
| Óbitos por município (DATASUS SIM, descompressor DBC próprio) | datasus | 2026 | há 4d | em dia |
| Agravos de notificação SINAN por município (tuberculose/hanseníase/violência) | datasus | 2024 | há 4d | em dia |
| Nascimentos por município (DATASUS SINASC DBC) | datasus | 2026 | há 4d | em dia |
| Apresentação Camada 2 (descrição → quantidade do conteúdo p/ itens-container); derivado de itens_sc + Camada 1, via SQL | derivado | 2025 | há 2d | em dia |
| Apresentação Camada LLM (Haiku extrai qtd do resíduo ambíguo, com abstenção); derivado, usa ANTHROPIC_API_KEY + cache | derivado | 2025 | há 20h | em dia |
| Apresentação Camada 1 (rótulo → unidade básica + fator de desempacotamento); derivado de itens_sc, via SQL | derivado | 2025 | há 20h | em dia |
| Compras por ente/ano — DERIVADA do espelho (contratacoes_sc, sem re-fetch) | derivado | 2026 | há 5h | em dia |
| Red-flag de unidade trocada no lançamento — item que destoa ≥100× da mediana do grupo CATMAT+base (efeito colateral do Passe 2); derivado | derivado | 2025 | há 20h | em dia |
| Referência por UNIDADE BÁSICA (Passe 2) — CATMAT+base+forma, mediana + curadoria IQR (IN 65 art.6); derivado de itens_sc + item_catmat_map + apresentação | derivado | 2025 | há 20h | em dia |
| Análise de compras por PREÇO UNITÁRIO — livro de preços de referência de SC + sobrepreço por município (derivado de itens_sc, via SQL) | derivado | 2025 | há 9d | em dia |
| Red flags de fornecedores — concentração + sanção (CEIS/CNEP) + sobrepreço por fornecedor (derivado de contratos/itens/sancoes, via SQL) | derivado | 2025 | há 9d | em dia |
| Re-derivação por fatia (evento → derivadas do ente) | derivado | 2025 | há 5h | em dia |
| Indícios de sobrepreço em medicamentos (compras do município vs teto legal PMVG, por substância+dosagem); derivado de cmed_pmvg + itens_sc | derivado | 2025 | há 4d | em dia |
| Reconstrução do sobrepreço com DUPLO benchmark — mediana de SC + referência nacional + desvio/CV (IN 65); derivado de itens_sc + precos_referencia_sc + precos_nacional_ref | derivado | 2025 | há 8d | em dia |
| Variação INTERNA de preços — mesmo município comprou o mesmo item a preços diferentes (derivado de itens_sc, via SQL) | derivado | 2025 | há 9d | em dia |
| Bolsa Atleta por município (Min. Esporte — atletas + valor) | esporte | 2025 | há 1h | pendente |
| Matrículas FUNDEB oficiais (FNDE Antonieta de Barros) | fnde | 2026 | há 4d | em dia |
| Parâmetros FUNDEB — fatores/VAAT/VAAR (FNDE) | fnde | 2026 | há 4d | em dia |
| PDDE por município (FNDE — Plataforma Antonieta de Barros) | fnde | 2024 | há 4d | em dia |
| PDDE saldo parado (verba escolar não executada) por município (FNDE Antonieta de Barros) | fnde | 2025 | há 20h | em dia |
| PNAE % agricultura familiar (mínimo legal 30%) por município (FNDE) | fnde | 2025 | há 20h | em dia |
| PNLD reserva técnica — demanda de livros (FNDE — Antonieta de Barros) | fnde | 2025 | há 9d | em dia |
| Repasses federais FNS por bloco (Consulta Consolidada) | fns | 2026 | há 4d | em dia |
| Autos de infração ambiental por município (IBAMA, série 1990+) | ibama | — | há 9d | em dia |
| Áreas embargadas por município (IBAMA CSV) | ibama | — | há 20h | em dia |
| Agricultura e agricultura familiar por município — Censo Agropecuário 2017 (IBGE/SIDRA t/6778+6883): estabelecimentos + área, familiar vs não-familiar | ibge | 2025 | há 20h | em dia |
| Taxa de alfabetização 15+ Censo 2022 (IBGE SIDRA 9543) | ibge | 2025 | há 20h | em dia |
| População por cor/raça Censo 2022 (IBGE SIDRA 9605) | ibge | 2025 | há 4d | em dia |
| Domicílios + densidade domiciliar Censo 2022 (IBGE SIDRA 4712) | ibge | 2025 | há 20h | em dia |
| Georreferência dos entes (centroide/área/região — IBGE malhas; base p/ frete e variação de preço) | ibge | 2025 | há 20h | em dia |
| Indicadores (IBGE/CGU) | ibge | 2024 | há 5d | em dia |
| População indígena (IBGE Censo 2022) | ibge | — | há 20h | em dia |
| IBGE MUNIC — instrumentos de gestão (planos/conselhos/fundos/instrumentos legais) por município, da BASE DE DADOS oficial (xlsx), não SIDRA | ibge | 2025 | há 3d | em dia |
| PIB municipal preços correntes + per capita (IBGE SIDRA 5938) | ibge | 2025 | há 20h | em dia |
| População por faixa etária Censo 2022 + idosos/dependência (IBGE SIDRA 9514) | ibge | 2025 | há 20h | em dia |
| Saneamento por município (água/esgoto/lixo) — IBGE Censo 2022 via SIDRA (cobertura por domicílio) | ibge | 2025 | há 4d | em dia |
| Setores censitários Censo 2022 — perfil intraurbano (IBGE FTP) | ibge | 2025 | há 20h | em dia |
| % crianças 0-14 por setor → variável do mapa intraurbano (IBGE demografia) | ibge | 2025 | há 4d | em dia |
| Malha (polígonos) dos setores → mapa choropleth (IBGE GPKG) | ibge | 2025 | há 3d | em dia |
| % idosos por setor censitário → variável do mapa intraurbano (IBGE demografia) | ibge | 2025 | há 4d | em dia |
| Museus por município (IBRAM MuseusBr) | ibram | 2025 | há 4d | em dia |
| Assentamentos reforma agrária por município (INCRA/MDA SIPRA) | incra | — | há 20h | em dia |
| Censo Escolar — matrículas (INEP Sinopse) | inep | 2025 | há 3d | em dia |
| Educação especial/AEE por município (INEP Censo microdata) | inep | 2025 | há 20h | em dia |
| Número de turmas por etapa/rede (INEP Censo Escolar) | inep | 2025 | há 20h | em dia |
| Escolas por município + infraestrutura (INEP Censo Escolar) | inep | 2025 | há 3d | em dia |
| Taxa de evasão por etapa (INEP Fluxo/Transição) | inep | 2025 | há 36d | em dia |
| FNDE liberações por município (SIMAD, Playwright) | inep | 2025 | há 20h | em dia |
| IDEB — indicadores educacionais (INEP) | inep | 2025 | há 4d | em dia |
| Indicadores educacionais INEP (AFD/TDI/ATU/rendimento por município) | inep | 2025 | há 3d | em dia |
| Indicadores INEP por escola (georreferenciado) | inep | 2025 | há 3d | em dia |
| SAEB proficiência Port/Mat por etapa (INEP) | inep | 2025 | há 20h | em dia |
...
| Desmatamento PRODES por município (INPE, interseção PostGIS) | inpe | 2025 | há 4d | em dia |
| Focos de calor por município (INPE BDQueimadas, mensal) | inpe | 2026 | há 6d | em dia |
| IEGM — qualidade da gestão (TCE-SC/IRB, dados abertos) | irb | 2025 | há 4d | em dia |
| Cobertura vacinal SÉRIE 2015-2026 por município/vacina (SI-PNI LocalizaSUS, engine Qlik set-analysis) | localizasus | 2026 | há 20h | em dia |
| CAF — Cadastro Nacional da Agricultura Familiar (ex-DAP) por município: nº de agricultores familiares (MDA, XLSX mensal) | mda | 2025 | há 9d | em dia |
| IGD-M gestão PBF/CadÚnico por município (MDS/SAGI Solr) | mds | — | há 20h | em dia |
| SUAS repasse+SALDO na mesa por município (MDS/SAGI Solr) — recurso não usado | mds | 2025 | há 9d | em dia |
...
| RAIS — estoque de emprego formal por município (MTE, anual) | mte | 2025 | há 3d | em dia |
| Novo PAC obras por município (ObrasGov/Casa Civil) | obrasgov | 2025 | há 20h | em dia |
| Obras por município — detalhe (ObrasGov) | obrasgov | 2025 | há 4d | em dia |
| Equipamentos esportivos georreferenciados (OSM — mapa camada Esporte) | osm | — | há 4d | em dia |
| Equipamentos segurança/justiça/defesa civil georreferenciados (OSM + SAP/SC): polícia, bombeiros, defesa civil, prisional, socioeducativo | osm | — | há 4d | em dia |
| Atas de Registro de Preço (PNCP Consulta) | pncp | — | há 9d | em dia |
| Classificação dos itens → CATMAT/CATSER (dicionário, matcher v2) | pncp | — | há 2d | pendente |
| Busca diária do PNCP (compras/contratos/atas — ano corrente) | pncp | — | há 35d | em dia |
| Contratos (PNCP ano corrente, append) | pncp | 2027 | há 27d | pendente |
...
| Coleta incremental PNCP — o que mudou (enche a fila de eventos) | pncp | 2025 | há 20h | em dia |
...
| PCA (PNCP) | pncp | — | há 12h | em dia |
| Preço de referência por item (mediana SC) + classificação ata/efetivada — base da análise de preços | pncp | 2025 | há 51d | em dia |
...
| Sazonalidade de preço por categoria (melhor mês de compra, SC) | pncp | 2025 | há 50d | em dia |
| Acidentes em rodovias federais por município (PRF DATATRAN, série 2015+) | prf | 2025 | há 9d | em dia |
| Localidade dos fornecedores (CNPJ→UF/município) | receita | — | há 9d | em dia |
| Arrecadação federal por município (RFB, série 2019+) | rfb | 2025 | há 4d | em dia |
| Frota de veículos por município (SENATRAN) | senatran | 2025 | há 4d | em dia |
| Qualidade (15 indicadores) + Vínculo/CVAT — novo cofinanciamento (SIAPS) | siaps | 2025 | há 20h | em dia |
| CAR — Cadastro Ambiental Rural: nº de imóveis rurais por município (SICAR GeoServer WFS, contagem por município) | sicar | 2025 | há 4d | em dia |
| Acompanhamento intra-anual da execução (RREO do bimestre vigente) — receita prevista×realizada e despesa orçada×empenhada por município | siconfi | 2025 | há 5d | em dia |
| Acompanhamento por função (intra-anual) — orçado×realizado por função até o bimestre vigente (RREO Anexo 02 parcial) | siconfi | 2025 | há 5d | em dia |
| CNPJs do governo municipal (SICONFI+órgãos+RPPS) | siconfi | 2025 | há 5d | em dia |
| Despesa por subfunção (RREO an.2 — drill) | siconfi | 2025 | há 20h | em dia |
| Finanças (SICONFI RREO an.1/2) | siconfi | 2025 | há 20h | em dia |
| Metas Fiscais LDO (RREO an.6) | siconfi | 2025 | há 20h | em dia |
| MSC ancorada ao RREO — despesa empenhada por natureza e fonte (forma da MSC × total exato do RREO; reconcilia por construção) | siconfi | 2025 | há 5d | em dia |
| Receitas detalhadas (ICMS/FPM/IPTU/FUNDEB — RREO an.3) | siconfi | 2025 | há 20h | em dia |
| Pessoal/DCL (RGF) | siconfi | 2025 | há 20h | em dia |
| Previdência RPPS (RREO Anexo 04) | siconfi | 2025 | há 20h | em dia |
| Educação/RCL (RREO an.14/3) | siconfi | 2025 | há 20h | em dia |
| Salário-Educação por município (SICONFI DCA) | siconfi | 2025 | há 4d | em dia |
| Estatísticas vitais por município (IBGE Registro Civil — nascidos/óbitos, série) | sidra | 2024 | há 8d | em dia |
| Produção agropecuária (PAM/PPM) + empresas (CEMPRE) por município (IBGE SIDRA) | sidra | — | há 4d | em dia |
| Vítimas de crimes violentos letais por município (SINESP/MJSP, dados abertos) | sinesp | — | há 39d | em dia |
| Catálogo de Ações Orçamentárias Federais (SIOP dados abertos) — o que emenda financia por setor; cruza com acao_orcamentaria da indicação | siop | 2025 | há 4d | em dia |
| Saúde ASPS (SIOPS) | siops | 2025 | há 20h | em dia |
| Indicadores Previne + ISF (SISAB indicadorPainel — 10 quadrimestres) | sisab | 2025 | há 4d | em dia |
| Produção da APS (SISAB — fichas aprovadas, série mensal 2021+) | sisab | 2025 | há 9d | em dia |
| SNIS Água/Esgoto por município e prestador (atendimento, perdas, tratamento) — app Ministério das Cidades via Playwright; state-agnostic (UF/ANO) | snis | 2025 | há 4d | em dia |
| CAPAG capacidade de pagamento por município (STN/Tesouro) | tesouro | — | há 20h | em dia |
| Regularidade fiscal CAUC/CADIN (Tesouro) | tesouro | — | há 4d | em dia |
| Ranking da Qualidade da Informação Fiscal (Tesouro) por município | tesouro | 2025 | há 4d | em dia |
...
| Precatórios por município (estoque e quantidade) — API do TJSC, Regime Especial de Precatórios; replicável por UF (CNJ Res. 303) | tjsc | 2025 | há 20h | em dia |
...
| Convênios e contratos de repasse por município (SICONV/Transferegov, repositório detru — proposta+convenio) | transferegov | 2025 | há 15d | em dia |
...
| Emendas — EXECUÇÃO orçamentária federal (Portal da Transparência: empenhado×pago → recurso na mesa) | transferegov | 2026 | há 20h | em dia |
...
| Catálogo de programas Transferegov — gestão ágil (fundoafundo/programa_gestao_agil); complementa o catálogo unificado de 335 programas | transferegov | 2025 | há 20h | em dia |
| Programas federais curados de saúde/educação (Novo PAC, Requalifica UBS, Proinfância — casamento com carência; FNS/FNDE sem feed) | transferegov | 2025 | há 20h | em dia |
| Radar de Captação — programas + planos (Transferegov fundo a fundo, API viva) | transferegov | 2025 | há 20h | em dia |
| Assistência social / FNAS por município (MDS · MI Social/CadSUAS: CRAS, CREAS — déficit p/ casamento) | transferegov | 2025 | há 20h | em dia |
...
- status: **ok** · registros suspeitos (excluídos): 6 · sobrepreço unitário: 18887
