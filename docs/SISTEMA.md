...
> Gerada em 2026-09-14 05:34 -03 por `scripts/gerar_documentacao.mjs`. Reflete o estado real do código e do banco. **Não editar à mão.**
...
| `arquivo_texto_sc` | 679.627 | 17 (cnpj, ano, seq, sequencial_documento, cod_ibge, tipo_documento, titulo, texto…) |
| `arquivos_proc_feitos` | 257.852 | 3 (numero_controle, n, feito_em) |
| `arquivos_sc` | 679.627 | 14 (cnpj, ano, seq, sequencial_documento, cod_ibge, tipo_documento_id, tipo_documento, titulo…) |
...
| `atas_check` | 899 | 3 (cnpj_orgao, checado, n) |
| `atas_sc` | 137.942 | 12 (numero_controle_ata, cod_ibge, cnpj_orgao, ano_ata, numero_ata, numero_controle_compra, vigencia_inicio, vigencia_fim…) |
...
| `aux_mun_so_camara` | 61 | 9 (cod_ibge, uf, municipio, pessoas, fontes, rais_camara, rais_prefeitura, pct_da_prefeitura…) |
...
| `bancada_federal_sc` | 20 | 11 (id, casa, cod_externo, nome, partido, uf, email, telefone…) |
...
| `cadprev_dair_aplicacoes_resgate` | 199.670 | 19 (cod_ibge, nr_cnpj_entidade, sg_uf, no_ente, dt_mes, dt_ano, no_segmeto, tp_ativo…) |
| `cadprev_dair_carteira` | 377.295 | 17 (cod_ibge, nr_cnpj_entidade, sg_uf, no_ente, dt_mes_bimestre, dt_ano, no_segmento, no_tipo_ativo…) |
| `cadprev_dair_forma_gestao` | 8.789 | 17 (cod_ibge, nr_cnpj_entidade, sg_uf, no_ente, dt_mes, dt_ano, dt_envio, no_objeto_contratacao…) |
| `cadprev_dair_fundo_invest_analisados` | 103.102 | 14 (cod_ibge, nr_cnpj_entidade, sg_uf, no_ente, dt_mes, dt_ano, dt_envio, nr_cnpj_empresa…) |
| `cadprev_dair_governanca` | 26.068 | 26 (cod_ibge, nr_cnpj_entidade, no_ente, sg_uf, dt_mes, dt_ano, dt_envio, nr_norma_fundamento…) |
| `cadprev_dair_identificacao` | 9.643 | 13 (cod_ibge, nr_cnpj_entidade, sg_uf, no_ente, dt_mes, dt_ano, dt_envio, te_finalidade…) |
...
| `cadprev_sync_log` | 484 | 5 (id, recurso, uf, linhas, ts) |
...
| `catalogo_govbr_sc` | 23.714 | 7 (nivel, tipo, cod, nome, classe, grupo, atualizado_em) |
...
| `ceap_despesas_deputados` | 100.614 | 29 (id_deputado, nome_parlamentar, cpf, uf, partido, num_sub_cota, descricao_despesa, especificacao_sub_cota…) |
| `ceaps_despesas_senadores` | 12.703 | 15 (id, tipo_documento, ano, mes, cod_senador, nome_senador, tipo_despesa, cpf_cnpj…) |
...
| `cnpj_loc` | 65.377 | 10 (cnpj, razao_social, municipio, uf, atualizado, situacao, situacao_motivo, abertura…) |
...
| `coleta_incremental_log` | 50 | 9 (rodada_em, uf, janela_ini, janela_fim, vistos, mudaram, iguais, novos…) |
...
| `compras_sc` | 1.119 | 10 (cod_ibge, ano, n_contratos, valor_estimado, valor_homologado, economia_pct, dispensa_pct, por_modalidade…) |
| `compras_sc_vazios` | 247 | 1 (cod_ibge) |
| `contratacao_disputa_sc` | 997 | 10 (cod_ibge, cnpj, ano, seq, n_licitantes, n_lances, n_itens_marca, atualizado…) |
| `contratacoes` | 1.035 | 13 (id, ente_tipo, ente_id, numero, objeto, orgao, modalidade, valor_estimado…) |
| `contratacoes_sc` | 257.853 | 35 (cod_ibge, cnpj, ano, seq, esfera, plataforma, modalidade_id, modalidade…) |
| `contrato_sc` | 25.952 | 30 (cnpj, ano, seq, cod_ibge, uf, municipio_nome, numero_controle_pncp, numero_controle_compra…) |
| `contratos_sc` | 8.992.221 | 14 (id, cod_ibge, numero_controle_compra, cnpj_compra, ano_compra, seq_compra, fornecedor, ni_fornecedor…) |
...
| `crp_alertas` | 759 | 11 (id, cod_ibge, nome, eh_estado, evento, categoria_de, categoria_para, dias…) |
...
| `dirigentes_atuais_estatais_federais` | 77 | 9 (empresa_sigla, cargo, nome, situacao, confianca, fonte, data_referencia, _hash…) |
| `dirigentes_sem_remuneracao_encontrada` | 1 | 9 (uf, empresa_sigla, empresa_nome, cargo, nome, observacao, fonte, _hash…) |
...
| `empenho_sc` | 236 | 10 (cnpj, ano, seq, sequencial_empenho, cod_ibge, numero_empenho, valor, data_emissao…) |
| `empenhos_check` | 40.135 | 6 (cnpj_compra, ano_compra, seq_compra, checado, n, tentativas) |
...
| `folha_camara_federal` | 513 | 21 (id_deputado, id_legislatura, nome, nome_civil, sexo, partido, uf, email…) |
| `folha_camara_fila` | 3.304 | 18 (cod_ibge, uf, municipio, situacao, pessoas, rais_legislativo, url_camara, erp…) |
...
| `folha_diagnostico_camara` | 2.441 | 13 (cod_ibge, municipio, uf, url_visitada, url_pessoal, produto, tem_menu_pessoal, tem_dados…) |
| `folha_diagnostico_faltante` | 2.059 | 13 (cod_ibge, municipio, uf, url_visitada, url_pessoal, produto, tem_menu_pessoal, tem_dados…) |
...
| `folha_govbrda_coleta` | 480 | 11 (cod_ibge, poder, municipio, uf, host, entidade, exercicio, linhas…) |
...
| `folha_ipm_coleta` | 276 | 9 (cod_ibge, municipio, uf, competencia, linhas, situacao, detalhe, em…) |
...
| `folha_ma_camara_coleta` | 11 | 9 (cod_ibge, municipio, uf, competencia, linhas, pessoas, situacao, detalhe…) |
| `folha_ma_func_coleta` | 12 | 10 (cod_ibge, poder, municipio, uf, competencia, linhas, pessoas, situacao…) |
| `folha_ma_zeus_coleta` | 9 | 10 (cod_ibge, municipio, uf, competencia, entidade_declarada, linhas, pessoas, situacao…) |
...
| `folha_pe_leg_coleta` | 16 | 9 (cod_ibge, municipio, uf, competencia, linhas, pessoas, situacao, detalhe…) |
...
| `folha_portalfacil_api_coleta` | 268 | 10 (id_cliente, cod_ibge, municipio, uf, situacao, detalhe, pessoas, linhas…) |
...
| `folha_portaltp_coleta` | 331 | 9 (cod_ibge, municipio, uf, competencia, linhas, situacao, detalhe, em…) |
...
| `folha_scpi_coleta` | 723 | 9 (cod_ibge, municipio, uf, host, linhas, situacao, detalhe, em…) |
| `folha_scpi_competencia_principal` | 368 | 6 (cod_ibge, municipio, mes, pessoas, meses_na_tabela, em) |
| `folha_scpicsv_coleta` | 320 | 11 (host, cod_ibge, municipio, uf, base, competencia, linhas, meses…) |
| `folha_scriptcase_coleta` | 1 | 9 (cod_ibge, poder, municipio, uf, competencia, linhas, situacao, detalhe…) |
| `folha_senado_federal` | 81 | 27 (codigo_parlamentar, codigo_publico_leg_atual, nome_parlamentar, nome_completo, sexo, forma_tratamento, partido, uf…) |
...
| `folha_servidores_betha` | 533.417 | 21 (cod_ibge, municipio, uf, entidade, competencia, nome, cargo, classificacao_cargo…) |
...
| `folha_servidores_govbrda` | 290.586 | 19 (cod_ibge, municipio, uf, poder, entidade, competencia, matricula, cpf_masc…) |
...
| `folha_servidores_ma_camara` | 87 | 17 (cod_ibge, municipio, uf, entidade, competencia, tipo_folha, matricula, cpf_masc…) |
| `folha_servidores_ma_func` | 1.535 | 17 (cod_ibge, municipio, uf, poder, competencia, nome, cargo, lotacao…) |
| `folha_servidores_ma_zeus` | 147 | 18 (cod_ibge, municipio, uf, entidade, competencia, tipo_folha, matricula, servidor_id…) |
| `folha_servidores_megasoft` | 104.373 | 21 (cod_ibge, municipio, uf, slug, competencia, matricula, nome, cpf_masc…) |
| `folha_servidores_memory` | 65.625 | 14 (cod_ibge, municipio, uf, entidade, competencia, matricula, nome, cargo…) |
...
| `folha_servidores_pe_leg` | 633 | 18 (cod_ibge, municipio, uf, entidade, competencia, matricula, cpf_masc, nome…) |
...
| `folha_servidores_portalfacil_api` | 130.974 | 21 (cod_ibge, municipio, uf, competencia, id_cliente, entidade, matricula, nome…) |
...
| `folha_servidores_scpi` | 281.828 | 19 (cod_ibge, municipio, uf, host, referencia, matricula, contrato, data_admissao…) |
| `folha_servidores_scpicsv` | 538.959 | 21 (cod_ibge, municipio, uf, host, competencia, referencia, matricula, contrato…) |
| `folha_servidores_scriptcase` | 2.242 | 12 (cod_ibge, municipio, uf, poder, competencia, nome, vinculo, simbolo…) |
| `folha_servidores_siapapi` | 40.091 | 15 (cod_ibge, municipio, uf, host, entidade, competencia, matricula, nome…) |
...
| `folha_servidores_ss` | 141.922 | 16 (cod_ibge, municipio, uf, entcod, entidade, poder, competencia, secretaria…) |
| `folha_servidores_sys523` | 9.857 | 14 (cod_ibge, municipio, uf, entidade, competencia, nome, cargo, lotacao…) |
...
| `folha_servidores_transpcidadao` | 11.857 | 22 (cod_ibge, municipio, uf, id_cidade, entidade, competencia, matricula, nome…) |
...
| `folha_ss_coleta` | 242 | 10 (entcod, cod_ibge, municipio, uf, entidade, competencia, linhas, situacao…) |
...
| `frescor_log` | 83 | 6 (id, rodado_em, total, ok, resumo, problemas) |
...
| `item_apresentacao_desc_sc` | 48.669 | 7 (chave, unidade_basica, fator, conf, metodo, n_itens, atualizado) |
| `item_apresentacao_sc` | 3.082 | 9 (unidade, unidade_basica, fator, forma, dimensao, conf, metodo, n_itens…) |
| `item_catmat_map` | 72.038 | 10 (chave, codigo_pdm, nome_pdm, nome_classe, sim, n_itens, atualizado, aceito…) |
...
| `item_catser_map` | 16.947 | 10 (chave, codigo_servico, nome_servico, nome_classe, nome_secao, sim, n_itens, aceito…) |
...
| `item_marca_sc` | 16.441 | 12 (cod_ibge, cnpj, ano, seq, numero, descricao, produto_ata, modelo…) |
...
| `item_resultado_sc` | 1.744.923 | 23 (cod_ibge, cnpj, ano, seq, numero, sequencial_resultado, ni_fornecedor, nome_razao_social_fornecedor…) |
...
| `itens_classificacao_sc` | 754.680 | 14 (descr_norm, tipo, cat_nivel, cat_cod, cat_nome, cat_classe, shared, cobertura…) |
| `itens_proc_feitos` | 257.820 | 4 (numero_controle, n, feito_em, versao) |
| `itens_sc` | 2.348.431 | 49 (cod_ibge, cnpj, ano, seq, numero, descricao, unidade, quantidade…) |
...
| `marca_ancora_feitas` | 52.214 | 6 (cnpj, ano, seq, n_marca, via_haiku, feito_em) |
| `marca_ata_feitas` | 149.294 | 6 (cnpj, ano, seq, n_marcas, feito_em, n_propostas) |
| `marca_tpl_feitas` | 152.624 | 5 (cnpj, ano, seq, n_marca, feito_em) |
...
| `mislabel_unidade_sc` | 2.305 | 13 (cod_ibge, nome_pdm, descricao, unidade, unit_homologado, unidade_basica, pub, med…) |
...
| `notificacao_impacto` | 489 | 7 (id, cod_ibge, alerta_id, tipo_impacto, valor, descricao, registrado_em) |
| `notificacao_log` | 12.820 | 11 (id, cod_ibge, alerta_id, chave_delta, destinatario_id, canal, severidade, enviado_em…) |
| `notificacao_regras` | 55 | 12 (alerta_id, titulo, secretaria, natureza, severidade, tem_prazo, fonte_dado, solucao_i10…) |
| `novopac_sc` | 27 | 5 (cod_ibge, projetos, valor_previsto, em_andamento, atualizado) |
| `obras_sc` | 2.353 | 14 (id_unico, cod_ibge, nome, situacao, especie, natureza, valor, origem…) |
| `orgaos_municipais_sc` | 888 | 2 (cod_ibge, cnpj) |
...
| `pg_stat_statements` | 4.002 | 52 (userid, dbid, toplevel, queryid, query, plans, total_plan_time, min_plan_time…) |
...
| `pncp_evento` | 242.945 | 22 (cnpj, ano, seq, cod_ibge, categoria, acao, item_numero, resultado_sequencial…) |
...
| `portal_produto` | 1.111 | 8 (cod_ibge, municipio, uf, url, produto, evidencia, em, achado_em) |
...
| `precos_referencia_basica_sc` | 5.238 | 12 (codigo_pdm, nome_pdm, nome_classe, unidade_basica, forma, n_compras, n_munis, n_excluidos…) |
| `precos_referencia_sc` | 1.935 | 13 (chave, unidade, mediana, p25, p75, n_itens, n_munis, catmat_pdm…) |
| `precos_referencia_servico_sc` | 2.006 | 16 (taxonomia, codigo, nome, classe, unidade, n_compras, n_munis, n_excluidos…) |
...
| `processos_sc` | 257.853 | 11 (cnpj_orgao, ano, sequencial, cod_ibge, numero_controle, modalidade_id, modalidade, objeto…) |
...
| `queimadas_sc` | 5.443 | 7 (cod_ibge, ano, mes, focos, risco_medio, bioma, atualizado) |
...
| `red_flags_fornecedores_sc` | 74.768 | 12 (cod_ibge, ni, fornecedor, n_contratos, valor_total, share_pct, sancionado, sanc_tipo…) |
...
| `rpps_crp_sc` | 14.419 | 9 (cod_ibge, nr_cnpj_entidade, no_ente, sg_uf, nr_crp, ds_situacao, tp_crp, dt_emissao…) |
...
| `salic_sc` | 178 | 6 (cod_ibge, projetos, aprovado, captado, gap, atualizado) |
| `sancoes` | 28.152 | 11 (id, fonte, ni, tipo_pessoa, nome, tipo_sancao, orgao, data_inicio…) |
...
| `sicro_composicoes_sc` | 6.618 | 5 (codigo, descricao, unidade, custo, competencia) |
| `sicro_equipamentos_sc` | 546 | 12 (codigo, descricao, valor_aquisicao, depreciacao_hora, oportunidade_capital_hora, seguros_impostos_hora, manutencao_hora, operacao_hora…) |
| `sicro_insumos_sc` | 1.849 | 7 (codigo, descricao, tipo, unidade, preco_nao_desonerado, preco_desonerado, competencia) |
| `siesc_edificacoes_sc` | 1.584 | 9 (codigo, grupo, descricao, unidade, custo_execucao, custo_material, custo_subservico, preco_unitario…) |
| `sigtap_financiamento` | 7 | 5 (co_financiamento, no_financiamento, dt_competencia, competencia, fonte_zip) |
| `sigtap_forma_organizacao` | 420 | 7 (co_grupo, co_sub_grupo, co_forma_organizacao, no_forma_organizacao, dt_competencia, competencia, fonte_zip) |
| `sigtap_grupo` | 9 | 5 (co_grupo, no_grupo, dt_competencia, competencia, fonte_zip) |
| `sigtap_modalidade` | 4 | 5 (co_modalidade, no_modalidade, dt_competencia, competencia, fonte_zip) |
| `sigtap_procedimento` | 5.023 | 18 (co_procedimento, no_procedimento, tp_complexidade, tp_sexo, qt_maxima_execucao, qt_dias_permanencia, qt_pontos, vl_idade_minima…) |
| `sigtap_sub_grupo` | 70 | 6 (co_grupo, co_sub_grupo, no_sub_grupo, dt_competencia, competencia, fonte_zip) |
...
| `sinapi_composicoes_sc` | 7.829 | 15 (codigo, descricao, unidade, classe, sigla_classe, tipo1, sigla_tipo1, cod_agrupador…) |
| `sinapi_insumos_sc` | 4.839 | 8 (codigo, descricao, unidade, origem_preco, preco_nao_desonerado, preco_desonerado, competencia, localidade) |
...
| `sobrepreco_compras_sc` | 5.583 | 15 (cod_ibge, chave, unidade, descricao, ano, quantidade, unit_pago, unit_ref…) |
...
| `tmp_571` | 571 | 3 (cod_ibge, uf, municipio) |
| `tmp_nunca` | 537 | 3 (cod_ibge, uf, municipio) |
| `tmp_sem_nada` | 1.238 | 3 (cod_ibge, uf, municipio) |
...
| `variacao_interna_sc` | 4.022 | 10 (cod_ibge, descricao, unidade, n_compras, menor, maior, razao, qtd_total…) |
...
| `vw_folha_camara_homonimo` | NaN | 0 () |
| `vw_folha_camara_pessoa` | NaN | 0 () |
...
| `vw_folha_mg` | 620.581 | 7 (fonte, cod_ibge, competencia, nome, cargo, secretaria, valor) |
| `vw_folha_municipal_brasil` | 32.309.746 | 16 (fonte, natureza, uf, competencia, cod_ibge, municipio, orgao, secretaria…) |
| `vw_folha_municipal_sc` | 4.430.699 | 14 (anomes, cod_ibge, municipio, orgao, poder, lotacao_origem, area, cargo…) |
| `vw_folha_municipio_qualidade` | 12.467 | 9 (fonte, uf, cod_ibge, municipio, linhas, tem_cargo, tem_salario, tem_secretaria…) |
| `vw_folha_oficial` | 21.193.215 | 14 (fonte, natureza, uf, competencia, cod_ibge, municipio, orgao, secretaria…) |
| `vw_folha_pi` | 48.225 | 7 (fonte, cod_ibge, competencia, nome, cargo, secretaria, valor) |
...
| `scripts/_precos_norm.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ _precos_norm.mjs — fragmentos SQL de NORMALIZAÇÃO da descrição e CA |
...
| `scripts/_siesc_raw/testparse.mjs` | — |
...
| `scripts/_tmp_1238.mjs` | — |
| `scripts/_tmp_1238b.mjs` | — |
| `scripts/_tmp_24.mjs` | — |
| `scripts/_tmp_24b.mjs` | — |
| `scripts/_tmp_36.mjs` | — |
| `scripts/_tmp_537.mjs` | — |
| `scripts/_tmp_537b.mjs` | — |
| `scripts/_tmp_571.mjs` | — |
| `scripts/_tmp_agora.mjs` | — |
| `scripts/_tmp_alc.mjs` | — |
| `scripts/_tmp_alc2.mjs` | — |
| `scripts/_tmp_and.mjs` | — |
| `scripts/_tmp_avul.mjs` | — |
| `scripts/_tmp_avul2.mjs` | — |
| `scripts/_tmp_bel10.mjs` | — |
| `scripts/_tmp_bel11.mjs` | — |
| `scripts/_tmp_bel12.mjs` | — |
| `scripts/_tmp_bel13.mjs` | — |
| `scripts/_tmp_bel14.mjs` | — |
| `scripts/_tmp_bel2.mjs` | — |
| `scripts/_tmp_bel3.mjs` | — |
| `scripts/_tmp_bel4.mjs` | — |
| `scripts/_tmp_bel5.mjs` | — |
| `scripts/_tmp_bel6.mjs` | — |
| `scripts/_tmp_bel7.mjs` | — |
| `scripts/_tmp_bel8.mjs` | — |
| `scripts/_tmp_bel9.mjs` | — |
| `scripts/_tmp_belem.mjs` | — |
| `scripts/_tmp_blocos.mjs` | — |
| `scripts/_tmp_brejo.mjs` | — |
| `scripts/_tmp_c283.mjs` | — |
| `scripts/_tmp_c360.mjs` | — |
| `scripts/_tmp_caj.mjs` | — |
| `scripts/_tmp_caj2.mjs` | — |
| `scripts/_tmp_camfim.mjs` | — |
| `scripts/_tmp_ce.mjs` | — |
| `scripts/_tmp_cf.mjs` | — |
| `scripts/_tmp_classif.mjs` | — |
| `scripts/_tmp_col78.mjs` | — |
| `scripts/_tmp_conf2.mjs` | — |
| `scripts/_tmp_cons.mjs` | — |
| `scripts/_tmp_contra.mjs` | — |
| `scripts/_tmp_desfaz.mjs` | — |
| `scripts/_tmp_dest.mjs` | — |
| `scripts/_tmp_diag.mjs` | — |
| `scripts/_tmp_ef.mjs` | — |
| `scripts/_tmp_estado.mjs` | — |
| `scripts/_tmp_execfim.mjs` | — |
| `scripts/_tmp_falta.mjs` | — |
| `scripts/_tmp_fim.mjs` | — |
| `scripts/_tmp_fim2.mjs` | — |
| `scripts/_tmp_fim3.mjs` | — |
| `scripts/_tmp_final.mjs` | — |
| `scripts/_tmp_final2.mjs` | — |
| `scripts/_tmp_g2.mjs` | — |
| `scripts/_tmp_ganho.mjs` | — |
| `scripts/_tmp_gb.mjs` | — |
| `scripts/_tmp_gb2.mjs` | — |
| `scripts/_tmp_gb3.mjs` | — |
| `scripts/_tmp_gb4.mjs` | — |
| `scripts/_tmp_gbest.mjs` | — |
| `scripts/_tmp_gbfim.mjs` | — |
| `scripts/_tmp_gbg.mjs` | — |
| `scripts/_tmp_http.mjs` | — |
| `scripts/_tmp_ma.mjs` | — |
| `scripts/_tmp_ma1.mjs` | — |
| `scripts/_tmp_ma2.mjs` | — |
| `scripts/_tmp_ma3.mjs` | — |
| `scripts/_tmp_ma4.mjs` | — |
| `scripts/_tmp_ma5.mjs` | — |
| `scripts/_tmp_marca.mjs` | — |
| `scripts/_tmp_novo.mjs` | — |
| `scripts/_tmp_parcial.mjs` | — |
| `scripts/_tmp_pds.mjs` | — |
| `scripts/_tmp_pds2.mjs` | — |
| `scripts/_tmp_pds3.mjs` | — |
| `scripts/_tmp_pds4.mjs` | — |
| `scripts/_tmp_pds5.mjs` | — |
| `scripts/_tmp_pe.mjs` | — |
| `scripts/_tmp_peapi.mjs` | — |
| `scripts/_tmp_pehtml.mjs` | — |
| `scripts/_tmp_pejs.mjs` | — |
| `scripts/_tmp_pemenu.mjs` | — |
| `scripts/_tmp_pen.mjs` | — |
| `scripts/_tmp_pen2.mjs` | — |
| `scripts/_tmp_pen3.mjs` | — |
| `scripts/_tmp_pen4.mjs` | — |
| `scripts/_tmp_pepg.mjs` | — |
| `scripts/_tmp_pepost.mjs` | — |
| `scripts/_tmp_peprobe.mjs` | — |
| `scripts/_tmp_perow.mjs` | — |
| `scripts/_tmp_pes.mjs` | — |
| `scripts/_tmp_petipo.mjs` | — |
| `scripts/_tmp_pi.mjs` | — |
| `scripts/_tmp_pichk.mjs` | — |
| `scripts/_tmp_pifim.mjs` | — |
| `scripts/_tmp_pifim2.mjs` | — |
| `scripts/_tmp_pifinal.mjs` | — |
| `scripts/_tmp_placfim.mjs` | — |
| `scripts/_tmp_placfinal.mjs` | — |
| `scripts/_tmp_pref.mjs` | — |
| `scripts/_tmp_probe.mjs` | — |
| `scripts/_tmp_prod.mjs` | — |
| `scripts/_tmp_ptp.mjs` | — |
| `scripts/_tmp_ptp2.mjs` | — |
| `scripts/_tmp_ptp3.mjs` | — |
| `scripts/_tmp_re.mjs` | — |
| `scripts/_tmp_rech.mjs` | — |
| `scripts/_tmp_ret.mjs` | — |
| `scripts/_tmp_ret2.mjs` | — |
| `scripts/_tmp_rotas.mjs` | — |
| `scripts/_tmp_rotas2.mjs` | — |
| `scripts/_tmp_scpi.mjs` | — |
| `scripts/_tmp_semnada2.mjs` | — |
| `scripts/_tmp_siap.mjs` | — |
| `scripts/_tmp_sp2.mjs` | — |
| `scripts/_tmp_sp210.mjs` | — |
| `scripts/_tmp_sr.mjs` | — |
| `scripts/_tmp_ss.mjs` | — |
| `scripts/_tmp_st.mjs` | — |
| `scripts/_tmp_tcm1.mjs` | — |
| `scripts/_tmp_tcm2.mjs` | — |
| `scripts/_tmp_tcm3.mjs` | — |
| `scripts/_tmp_tcm4.mjs` | — |
| `scripts/_tmp_td.mjs` | — |
| `scripts/_tmp_ultimo.mjs` | — |
| `scripts/_tmp_url.mjs` | — |
| `scripts/_tmp_varre.mjs` | — |
| `scripts/_tmp_why.mjs` | — |
| `scripts/_tmp_zcampo.mjs` | — |
| `scripts/_tmp_zero.mjs` | — |
| `scripts/_tmp_zeus.mjs` | — |
| `scripts/_tmp_zfim.mjs` | — |
| `scripts/_tmp_zprog.mjs` | — |
| `scripts/_tmp_zver.mjs` | — |
...
| `scripts/ab_catmat_enriquecido.mjs` | A/B do CATMAT: casar sobre a descrição CRUA da API × sobre a descrição ENRIQUECIDA dos documentos.  POR QUE ESTE SCRIPT EXISTE: o motor (match_item_catmat.mjs) casa sobre itens_sc |
...
| `scripts/analisa_cobertura_catser.mjs` | O "nenhum" do gabarito de SERVIÇO é ausência de CANDIDATO ou ausência de CÓDIGO?   node scripts/analisa_cobertura_catser.mjs  ═══ A PERGUNTA ═══ O gabarito diz "nenhum candidato |
...
| `scripts/avalia_contra_gabarito.mjs` | AVALIA os classificadores de item contra `app.gabarito_item` — o ponto de operação, medido.   node scripts/avalia_contra_gabarito.mjs  Substitui o `eval_operating_point.mjs`, que n |
| `scripts/avalia_reranker_gabarito.mjs` | O RERANKER-LLM ganha do trigrama? Medido contra `app.gabarito_item`, ANTES de gastar na cauda inteira.   node scripts/avalia_reranker_gabarito.mjs  ═══ POR QUE MEDIR ANTES ═══ R |
...
| `scripts/build_catmat_pdm.mjs` | catmat_pdm — o ALVO do casamento do CATMAT, agregado a partir de catmat_catalogo.   node scripts/build_catmat_pdm.mjs  ═══ POR QUE ESTE ARQUIVO PRECISOU EXISTIR (01/set/2026) ═══ ` |
...
| `scripts/build_item_busca.mjs` | DICIONÁRIO DE BUSCA do Banco de Preços — uma linha por DESCRIÇÃO DISTINTA de item comprado. node scripts/build_item_busca.mjs  ═══ POR QUE ESTA TABELA EXISTE (02/set/2026) ═══ A |
| `scripts/build_item_classificacao.mjs` | CAMADA ÚNICA DE CLASSIFICAÇÃO DO ITEM — uma resposta por descrição, com procedência.   node scripts/build_item_classificacao.mjs  ═══ O PROBLEMA QUE ISTO RESOLVE ═══ Em 01/set/2 |
...
| `scripts/build_precos_servico_sc.mjs` | BANCO DE PREÇOS DE SERVIÇO — o irmão de `build_precos_basica_sc.mjs`, no eixo que ele não cobre.   node scripts/build_precos_servico_sc.mjs  ═══ POR QUE UMA TABELA SEPARADA, E NÃO  |
...
| `scripts/cadeias.mjs` | AS CADEIAS COMO DADO — quem roda o quê, em que ordem, com que ambiente e com que regra de falha.  Antes daqui isso morava espalhado em seis arquivos .cmd, cada um com a sua conven |
...
| `scripts/casa_item_sigtap.mjs` | CASAMENTO item→SIGTAP — determinístico, sem similaridade e sem LLM.   node scripts/casa_item_sigtap.mjs  ═══ POR QUE ISTO NÃO É UM CLASSIFICADOR ═══ O município escreve o código do |
...
| `scripts/constroi_gabarito_item.mjs` | GABARITO de classificação de item — a RÉGUA contra a qual CATMAT e CATSER são medidos.   node scripts/constroi_gabarito_item.mjs            # rotula o que ainda não tem rótulo   AM |
...
| `scripts/descobre_host_govbr.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ descobre_host_govbr.mjs — acha o HOST REAL do portal GovBR/PRONIM l |
...
| `scripts/diagnostica_faltantes.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ diagnostica_faltantes.mjs — abre o portal de CADA município ainda s |
...
| `scripts/enriquece_item_documento.mjs` | ENRIQUECEDOR — consome o corpus JÁ GUARDADO (arquivo_texto_sc + itens_sc) e, por item, percorre TODOS os documentos da construção DO PRIMEIRO AO ÚLTIMO (DFD→ETP→TR→Edital…), local |
...
| `scripts/eval_operating_point.mjs` | ⛔⛔ APOSENTADO EM 01/set/2026 — ESTE SCRIPT NÃO RODA MAIS. Ele carrega os rótulos de `sc_strat_ws.tsv`, um arquivo que vivia no scratchpad de uma sessão do Claude Code — pasta tem |
...
| `scripts/gate_ponto_operacao.mjs` | PORTÃO DE REGRESSÃO do ponto de operação da classificação de item. Importado por avalia_contra_gabarito.mjs; grava a medição de cada rodada e COMPARA com a anterior.  ═══ POR QUE U |
...
| `scripts/identifica_produto_portal.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ identifica_produto_portal.mjs — descobre QUAL PRODUTO roda por trás |
...
| `scripts/ingest_catser_catalogo.mjs` | Catálogo CATSER (SERVIÇOS) completo — a taxonomia federal de serviço, irmã do CATMAT. Fonte: dadosabertos.compras.gov.br/modulo-servico/6_consultarItemServico (7 páginas × 500). NA |
...
| `scripts/ingest_ceap_deputados.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_ceap_deputados.mjs — CEAP (Cota para o Exercício da Atividade |
| `scripts/ingest_ceaps_senadores.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_ceaps_senadores.mjs — CEAPS: verba indenizatória (Cota para E |
...
| `scripts/ingest_completa_fomento_pr.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_completa_fomento_pr.mjs — fecha as duas pendências de PR: Fom |
| `scripts/ingest_completa_membros_estatais_estaduais.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_completa_membros_estatais_estaduais.mjs — resposta a "isso es |
...
| `scripts/ingest_contratacoes_nacional.mjs` | COLETA NACIONAL dos processos do PNCP — roda o `ingest_contratacoes_sc.mjs` (que já é state-agnostic) para as 27 UFs, em ordem de tamanho, com retomada. node scripts/ingest_contrat |
...
| `scripts/ingest_dirigentes_atuais_estatais_federais.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_dirigentes_atuais_estatais_federais.mjs — nome de quem ocupa  |
...
| `scripts/ingest_folha_7focus.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_7focus.mjs — folha nominal do ERP 7Focus (forte no Toc |
...
| `scripts/ingest_folha_camara_federal.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_camara_federal.mjs — subsídio (salário) dos 513 Deputad |
...
| `scripts/ingest_folha_govbr_dadosabertos.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_govbr_dadosabertos.mjs — a folha do PRONIM/Cidade360 ( |
...
| `scripts/ingest_folha_ma_camara.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_ma_camara.mjs — folha das CÂMARAS do Maranhão no bloco  |
| `scripts/ingest_folha_ma_funcionarios.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_ma_funcionarios.mjs — bloco `/funcionarios` do Maranhã |
| `scripts/ingest_folha_ma_zeus.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_ma_zeus.mjs — folha das CÂMARAS do MA no CMS "zeus-cam" |
...
| `scripts/ingest_folha_pe_leg.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_pe_leg.mjs — folha das CÂMARAS de Pernambuco no white-l |
...
| `scripts/ingest_folha_portaltp.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_portaltp.mjs — folha dos municípios que usam o Portal  |
...
| `scripts/ingest_folha_senado.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ ingest_folha_senado.mjs — subsídio (salário) dos 81 Senadores da Rep |
...
| `scripts/ingest_precos_nacional.mjs` | Referência NACIONAL de preços por CATMAT (Painel de Preços / Compras.gov.br), casada por UNIDADE, para os PDMs que classificamos (precos_referencia_sc.catmat_cod). Só unidades SIM |
...
| `scripts/ingest_sicro_sc.mjs` | SICRO (Sistema de Custos Referenciais de Obras) — a referência do DNIT para OBRAS E SERVIÇOS DE INFRAESTRUTURA DE TRANSPORTES (Lei 14.133, art. 23 §2º), irmã do SINAPI: SINAPI cobr |
| `scripts/ingest_siesc_edificacoes_sc.mjs` | SIE-SC — Referencial de Preços de Obras de Edificações, da Secretaria de Infraestrutura e Mobilidade de Santa Catarina. Terceira régua de obra do Banco de Preços, ao lado de SINAPI |
| `scripts/ingest_sigtap.mjs` | SIGTAP — Tabela Unificada de Procedimentos do SUS. A TERCEIRA taxonomia do item municipal.   node scripts/ingest_sigtap.mjs  ═══ POR QUE ESTE ARQUIVO EXISTE (01/set/2026) ═══ **22, |
...
| `scripts/ingest_sinapi_sc.mjs` | SINAPI (Sistema Nacional de Pesquisa de Custos e Índices da Construção Civil) — referência federal de preço para OBRAS E SERVIÇOS DE ENGENHARIA (Caixa Econômica Federal + IBGE). É  |
...
| `scripts/mapa_camara_por_fonte.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ mapa_camara_por_fonte.mjs — onde a CÂMARA está ao alcance e não foi  |
...
| `scripts/mapa_folha_so_camara.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ mapa_folha_so_camara.mjs — os municípios que contam como "prefeitura |
...
| `scripts/match_item_catmat.mjs` | CASAMENTO item→CATMAT (trigrama pg_trgm) — classifica CADA descrição normalizada de bem (chave) no melhor PDM do catálogo. É o RETRIEVER validado pelo estudo (gabarito coloquial d |
| `scripts/match_item_catser.mjs` | CASAMENTO item→CATSER (trigrama pg_trgm) — o IRMÃO do match_item_catmat.mjs, para SERVIÇO.   node scripts/match_item_catser.mjs  ═══ POR QUE UM MOTOR SEPARADO, E NÃO UM RAMO DENT |
| `scripts/mede_escala_confianca.mjs` | MEDE a escala de confiança do enriquecimento — a afirmação em aberto é que `media` ACERTA MAIS que `alta`, o que tornaria o carimbo inútil (ou pior: enganoso para quem filtra por a |
...
| `scripts/promove_diagnostico_executivo.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ promove_diagnostico_executivo.mjs — leva o que o diagnóstico com na |
...
| `scripts/reclassifica_produto_govbr_falso.mjs` | ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════ reclassifica_produto_govbr_falso.mjs — conserta o PRODUTO no radar  |
...
| `scripts/verifica_noite.mjs` | VERIFICA A NOITE — responde "rodou tudo certo?" por MEDIÇÃO, e falha ALTO quando não.   node scripts/verifica_noite.mjs           (sai 1 se houver qualquer ALERTA)   HORAS=24 nod |
...
| `banco-precos-painel.tsx` | ═══ BANCO DE PREÇOS — a tela (02/set/2026) ═══ |
...
| `formulario-preco-referencia.tsx` | ═══ FORMULÁRIO DE PESQUISA DE PREÇOS — o documento que a norma exige (03/set/2026) ═══ |
...
| `orcamento-obra-painel.tsx` | ═══ ENVELOPE do Banco de Preços + as três referências de obra + o carrinho de orçamento (03/set/2026) ═══ |
| `orcamento-obra.tsx` | ═══ ORÇAMENTO DE OBRA — o carrinho que soma preço unitário × quantidade (03/set/2026) ═══ |
...
| `sicro-painel.tsx` | ═══ REFERÊNCIA SICRO (DNIT) — painel PRÓPRIO, par do SinapiPainel (03/set/2026) ═══ |
| `siesc-painel.tsx` | ═══ REFERENCIAL DE PREÇOS SIE-SC (Edificações) — painel PRÓPRIO (03/set/2026) ═══ |
| `sinapi-painel.tsx` | ═══ REFERÊNCIA SINAPI — painel PRÓPRIO, ao lado do Banco de Preços (03/set/2026) ═══ |
...
|---|---|---|---|---|
| Outorgas de uso da água por município (ANA, finalidade+série) | ana | — | há 36d | em dia |
| Barragens por município (ANA/SNISB — dano potencial + risco) | ana | 2025 | há 4h | pendente |
| Banda larga fixa por município (ANATEL, série 2007+) | anatel | — | há 4h | pendente |
| Geração distribuída de energia por município (ANEEL, série) | aneel | — | há 33d | em dia |
| CFEM — royalties de mineração por município (ANM, distribuição) | anm | 2026 | há 36d | em dia |
| Preços de combustíveis por município (ANP, semestral, série 2004+) | anp | 2021 | há 36d | em dia |
| Vendas de combustíveis por município (ANP, série 1990+) | anp | 2024 | há 4h | pendente |
| Cobertura de planos de saúde por município (ANS — pressão sobre o SUS) | ans | 2026 | há 36d | em dia |
| CMED/Anvisa PMVG — preço-teto legal de medicamentos (Conformidade Gov, auto-descobre URL); referência nacional p/ sobrepreço em saúde (SC = ICMS 17%) | anvisa | 2025 | há 41d | pendente |
| Desastres S2ID por município (Atlas Digital CEPED-UFSC/MIDR, série 1991+) | atlas | — | há 4h | pendente |
| IDHM + subíndices por município (Atlas Brasil PNUD, Censo 2010) | atlasbrasil | 2025 | há 36d | em dia |
| Sistema financeiro por município (BCB Olinda — agências/cooperativas/correspondentes + Pix série) | bcb | — | há 13d | em dia |
| ESTBAN — volumes bancários por município (BCB, crédito/poupança, série) | bcb | — | há 4h | pendente |
| PRONAF / Crédito Rural por município — valor contratado por ano (BCB SICOR/Matriz do Crédito Rural, OData; cdEstado=25) | bcb | 2025 | há 3d | em dia |
| BNDES desembolsos por município (crédito produtivo, série 1995+) | bndes | 2026 | há 36d | em dia |
| Espelho completo CADPREV (37 recursos: DAIR/DIPR/DRAA/RPPS_*) | cadprev | — | há 48d | pendente |
| Alertas de CRP (transições vencido/a vencer — varredura) | cadprev | — | há 0h | pendente |
| Déficit atuarial RPPS (CADPREV/DRAA) | cadprev | — | há 29d | em dia |
| Regularidade previdenciária CRP (CADPREV — Consulta Pública) | cadprev | — | há 4h | pendente |
| Equipamentos SUAS — fallback de geo por CEP (AwesomeAPI) | cadsuas | — | há 4h | pendente |
| Equipamentos SUAS — endereço/telefone (CadSUAS detalhe, HTTP) | cadsuas | — | há 4h | pendente |
| Equipamentos SUAS — geocodificação (Nominatim/OSM por endereço) | cadsuas | — | há 4h | pendente |
| Equipamentos SUAS por unidade (CadSUAS, Playwright): CRAS/CREAS/Centro POP/Acolhimento + nome/nº | cadsuas | — | há 4h | pendente |
| Estações de monitoramento de risco CEMADEN por município (defesa civil) | cemaden | 2025 | há 4h | pendente |
| Transferências (CGU) | cgu | — | há 4h | pendente |
| Transferências federais à prefeitura (CGU download em massa) | cgu | 2025 | há 4h | pendente |
| Habitação — MCMV (Minha Casa Minha Vida), unidades financiadas por município (Min. Cidades, gov.br/cidades — sem WAF); alimenta o casamento oportunidade×necessidade | cidades | 2025 | há 36d | em dia |
| Saneamento SINISA por município (água/esgoto/resíduos, Min. Cidades, ref 2024) | cidades | 2024 | há 36d | em dia |
| CNES — rede de saúde (Min. Saúde) | cnes | 2026 | há 4h | pendente |
| Unidades de conservação por município (MMA CNUC, interseção PostGIS) | cnuc | — | há 36d | em dia |
| Catálogo oficial CATMAT/CATSER (Compras.gov.br) — espinha de classificação | compras | — | há 4h | pendente |
| Referência NACIONAL de preços por CATMAT (Painel de Preços/Compras.gov.br), por unidade e por forma (avulso×escala) — enriquece o Banco de Preços e o sobrepreço | compras | 2025 | há 11d | em dia |
| PAA compras agricultura familiar por município (Conab) | conab | 2025 | há 4h | pendente |
| Bancada federal do estado (deputados + senadores) p/ módulo de Captação de Emendas — APIs Câmara + Senado | congresso | 2025 | há 4h | pendente |
| Lei Paulo Gustavo execução/saldo por município (MinC) | cultura | 2025 | há 4h | pendente |
| Comunidades quilombolas certificadas por município (Palmares) | cultura | — | há 4h | pendente |
| Lei Rouanet SALIC — aprovado/captado por município (MinC) | cultura | 2025 | há 8d | em dia |
| APAC oncologia e diálise por município (SIA-APAC) | datasus | — | há 4h | pendente |
| Equipamentos médicos por estabelecimento (CNES EQ) | datasus | 2024 | há 36d | em dia |
| Equipes de saúde (ESF) por município/estabelecimento (CNES EP) | datasus | 2024 | há 36d | em dia |
| Estabelecimentos de saúde por município (CNES — rede p/ regulação, API DEMAS) | datasus | 2025 | há 4h | pendente |
| Leitos hospitalares por estabelecimento (CNES LT) | datasus | 2024 | há 36d | em dia |
| Profissionais de saúde por município/estabelecimento (CNES PF) | datasus | 2024 | há 4h | pendente |
| Medicamentos de alto custo CEAF por município (SIA grupo 06) | datasus | — | há 4h | pendente |
| Previne Brasil — indicadores APS (SISAB) | datasus | — | há 4h | pendente |
| Saúde mental CAPS/RAAS por município (SIA-RAAS-PS) | datasus | — | há 4h | pendente |
| SIA — produção ambulatorial (DATASUS) | datasus | 2025 | há 4h | pendente |
| Produção ambulatorial SUS por complexidade (DATASUS SIA + SIGTAP) | datasus | — | há 36d | em dia |
| Internações SUS por município (DATASUS SIH DBC mensal) | datasus | 2024 | há 36d | em dia |
| SIH — produção hospitalar (DATASUS TabNet) | datasus | 2025 | há 4h | pendente |
| Óbitos por município (DATASUS SIM, descompressor DBC próprio) | datasus | 2026 | há 36d | em dia |
| Agravos de notificação SINAN por município (tuberculose/hanseníase/violência) | datasus | 2024 | há 36d | em dia |
| Nascimentos por município (DATASUS SINASC DBC) | datasus | 2026 | há 36d | em dia |
| Apresentação Camada 2 (descrição → quantidade do conteúdo p/ itens-container); derivado de itens_sc + Camada 1, via SQL | derivado | 2025 | há 4h | pendente |
| Apresentação Camada LLM (Haiku extrai qtd do resíduo ambíguo, com abstenção); derivado, usa ANTHROPIC_API_KEY + cache | derivado | 2025 | há 4h | pendente |
| Apresentação Camada 1 (rótulo → unidade básica + fator de desempacotamento); derivado de itens_sc, via SQL | derivado | 2025 | há 4h | pendente |
| Compras por ente/ano — DERIVADA do espelho (contratacoes_sc, sem re-fetch) | derivado | 2026 | há 23h | em dia |
| Red-flag de unidade trocada no lançamento — item que destoa ≥100× da mediana do grupo CATMAT+base (efeito colateral do Passe 2); derivado | derivado | 2025 | há 4h | pendente |
| Referência por UNIDADE BÁSICA (Passe 2) — CATMAT+base+forma, mediana + curadoria IQR (IN 65 art.6); derivado de itens_sc + item_catmat_map + apresentação | derivado | 2025 | há 23h | em dia |
| Análise de compras por PREÇO UNITÁRIO — livro de preços de referência de SC + sobrepreço por município (derivado de itens_sc, via SQL) | derivado | 2025 | há 23h | em dia |
| Red flags de fornecedores — concentração + sanção (CEIS/CNEP) + sobrepreço por fornecedor (derivado de contratos/itens/sancoes, via SQL) | derivado | 2025 | há 4h | pendente |
| Re-derivação por fatia (evento → derivadas do ente) | derivado | 2025 | há 4h | pendente |
| Indícios de sobrepreço em medicamentos (compras do município vs teto legal PMVG, por substância+dosagem); derivado de cmed_pmvg + itens_sc | derivado | 2025 | há 36d | em dia |
| Reconstrução do sobrepreço com DUPLO benchmark — mediana de SC + referência nacional + desvio/CV (IN 65); derivado de itens_sc + precos_referencia_sc + precos_nacional_ref | derivado | 2025 | há 40d | em dia |
| Variação INTERNA de preços — mesmo município comprou o mesmo item a preços diferentes (derivado de itens_sc, via SQL) | derivado | 2025 | há 4h | pendente |
| Bolsa Atleta por município (Min. Esporte — atletas + valor) | esporte | 2025 | há 4h | pendente |
| Matrículas FUNDEB oficiais (FNDE Antonieta de Barros) | fnde | 2026 | há 36d | em dia |
| Parâmetros FUNDEB — fatores/VAAT/VAAR (FNDE) | fnde | 2026 | há 36d | em dia |
| PDDE por município (FNDE — Plataforma Antonieta de Barros) | fnde | 2024 | há 36d | em dia |
| PDDE saldo parado (verba escolar não executada) por município (FNDE Antonieta de Barros) | fnde | 2025 | há 4h | pendente |
| PNAE % agricultura familiar (mínimo legal 30%) por município (FNDE) | fnde | 2025 | há 4h | pendente |
| PNLD reserva técnica — demanda de livros (FNDE — Antonieta de Barros) | fnde | 2025 | há 4h | pendente |
| Repasses federais FNS por bloco (Consulta Consolidada) | fns | 2026 | há 6d | em dia |
| Autos de infração ambiental por município (IBAMA, série 1990+) | ibama | — | há 4h | pendente |
| Áreas embargadas por município (IBAMA CSV) | ibama | — | há 4h | pendente |
| Agricultura e agricultura familiar por município — Censo Agropecuário 2017 (IBGE/SIDRA t/6778+6883): estabelecimentos + área, familiar vs não-familiar | ibge | 2025 | há 4h | pendente |
| Taxa de alfabetização 15+ Censo 2022 (IBGE SIDRA 9543) | ibge | 2025 | há 4h | pendente |
| População por cor/raça Censo 2022 (IBGE SIDRA 9605) | ibge | 2025 | há 36d | em dia |
| Domicílios + densidade domiciliar Censo 2022 (IBGE SIDRA 4712) | ibge | 2025 | há 4h | pendente |
| Georreferência dos entes (centroide/área/região — IBGE malhas; base p/ frete e variação de preço) | ibge | 2025 | há 4h | pendente |
| Indicadores (IBGE/CGU) | ibge | 2024 | há 37d | em dia |
| População indígena (IBGE Censo 2022) | ibge | — | há 4h | pendente |
| IBGE MUNIC — instrumentos de gestão (planos/conselhos/fundos/instrumentos legais) por município, da BASE DE DADOS oficial (xlsx), não SIDRA | ibge | 2025 | há 35d | em dia |
| PIB municipal preços correntes + per capita (IBGE SIDRA 5938) | ibge | 2025 | há 4h | pendente |
| População por faixa etária Censo 2022 + idosos/dependência (IBGE SIDRA 9514) | ibge | 2025 | há 4h | pendente |
| Saneamento por município (água/esgoto/lixo) — IBGE Censo 2022 via SIDRA (cobertura por domicílio) | ibge | 2025 | há 36d | em dia |
| Setores censitários Censo 2022 — perfil intraurbano (IBGE FTP) | ibge | 2025 | há 4h | pendente |
| % crianças 0-14 por setor → variável do mapa intraurbano (IBGE demografia) | ibge | 2025 | há 36d | em dia |
| Malha (polígonos) dos setores → mapa choropleth (IBGE GPKG) | ibge | 2025 | há 35d | em dia |
| % idosos por setor censitário → variável do mapa intraurbano (IBGE demografia) | ibge | 2025 | há 36d | em dia |
| Museus por município (IBRAM MuseusBr) | ibram | 2025 | há 36d | em dia |
| Assentamentos reforma agrária por município (INCRA/MDA SIPRA) | incra | — | há 4h | pendente |
| Censo Escolar — matrículas (INEP Sinopse) | inep | 2025 | há 35d | em dia |
| Educação especial/AEE por município (INEP Censo microdata) | inep | 2025 | há 4h | pendente |
| Número de turmas por etapa/rede (INEP Censo Escolar) | inep | 2025 | há 4h | pendente |
| Escolas por município + infraestrutura (INEP Censo Escolar) | inep | 2025 | há 35d | em dia |
| Taxa de evasão por etapa (INEP Fluxo/Transição) | inep | 2025 | há 68d | em dia |
| FNDE liberações por município (SIMAD, Playwright) | inep | 2025 | há 4h | pendente |
| IDEB — indicadores educacionais (INEP) | inep | 2025 | há 36d | em dia |
| Indicadores educacionais INEP (AFD/TDI/ATU/rendimento por município) | inep | 2025 | há 35d | em dia |
| Indicadores INEP por escola (georreferenciado) | inep | 2025 | há 35d | em dia |
| SAEB proficiência Port/Mat por etapa (INEP) | inep | 2025 | há 4h | pendente |
| Arboviroses (dengue/zika/chikungunya) por município (InfoDengue/SINAN) | infodengue | 2025 | há 12d | em dia |
| Dengue por município (SINAN via InfoDengue, série + incidência) | infodengue | 2025 | há 12d | em dia |
| Desmatamento PRODES por município (INPE, interseção PostGIS) | inpe | 2025 | há 36d | em dia |
| Focos de calor por município (INPE BDQueimadas, mensal) | inpe | 2026 | há 8d | em dia |
| IEGM — qualidade da gestão (TCE-SC/IRB, dados abertos) | irb | 2025 | há 36d | em dia |
| Cobertura vacinal SÉRIE 2015-2026 por município/vacina (SI-PNI LocalizaSUS, engine Qlik set-analysis) | localizasus | 2026 | há 4h | pendente |
| CAF — Cadastro Nacional da Agricultura Familiar (ex-DAP) por município: nº de agricultores familiares (MDA, XLSX mensal) | mda | 2025 | há 4h | pendente |
| IGD-M gestão PBF/CadÚnico por município (MDS/SAGI Solr) | mds | — | há 4h | pendente |
| SUAS repasse+SALDO na mesa por município (MDS/SAGI Solr) — recurso não usado | mds | 2025 | há 4h | pendente |
| Guardião de frescor (série + última competência) | meta | — | há 0h | em dia |
| Saldo de empregos formais por município (Novo CAGED/MTE, mensal) | mte | 2026 | há 10d | em dia |
| RAIS — estoque de emprego formal por município (MTE, anual) | mte | 2025 | há 35d | em dia |
| Novo PAC obras por município (ObrasGov/Casa Civil) | obrasgov | 2025 | há 23h | em dia |
| Obras por município — detalhe (ObrasGov) | obrasgov | 2025 | há 6d | em dia |
| Equipamentos esportivos georreferenciados (OSM — mapa camada Esporte) | osm | — | há 36d | em dia |
| Equipamentos segurança/justiça/defesa civil georreferenciados (OSM + SAP/SC): polícia, bombeiros, defesa civil, prisional, socioeducativo | osm | — | há 36d | em dia |
| Atas de Registro de Preço (PNCP Consulta) | pncp | — | há 3d | em dia |
| Classificação dos itens → CATMAT/CATSER (dicionário, matcher v2) | pncp | — | há 2h | pendente |
| Busca diária do PNCP (compras/contratos/atas — ano corrente) | pncp | — | há 19h | em dia |
| Contratos (PNCP ano corrente, append) | pncp | 2027 | há 59d | pendente |
| Empenhos por contrato (PNCP Lei 14.133 — acende quando publicarem) | pncp | — | há 12d | em dia |
| Consumo de eventos → espelho (a fatia que o evento aponta) | pncp | 2025 | há 4h | pendente |
| Coleta incremental PNCP — o que mudou (enche a fila de eventos) | pncp | 2025 | há 4h | pendente |
| Itens de TODOS os processos (preço unitário) | pncp | 2025 | há 13d | em dia |
| Notas fiscais / instrumentos de cobrança (PNCP — acende quando publicarem) | pncp | — | há 9d | em dia |
| PCA (PNCP) | pncp | — | há 1d | em dia |
| Preço de referência por item (mediana SC) + classificação ata/efetivada — base da análise de preços | pncp | 2025 | há 83d | em dia |
| Contratações PNCP — TODAS (entidade Contratação espelhando o PNCP: modalidade/plataforma/SRP/estimado×homologado; via bulk por data) | pncp | 2025 | há 13d | em dia |
| Sazonalidade de preço por categoria (melhor mês de compra, SC) | pncp | 2025 | há 82d | em dia |
| Acidentes em rodovias federais por município (PRF DATATRAN, série 2015+) | prf | 2025 | há 10d | em dia |
| Localidade dos fornecedores (CNPJ→UF/município) | receita | — | há 23h | em dia |
| Arrecadação federal por município (RFB, série 2019+) | rfb | 2025 | há 36d | em dia |
| Frota de veículos por município (SENATRAN) | senatran | 2025 | há 36d | em dia |
| Qualidade (15 indicadores) + Vínculo/CVAT — novo cofinanciamento (SIAPS) | siaps | 2025 | há 4h | pendente |
| CAR — Cadastro Ambiental Rural: nº de imóveis rurais por município (SICAR GeoServer WFS, contagem por município) | sicar | 2025 | há 36d | em dia |
| Acompanhamento intra-anual da execução (RREO do bimestre vigente) — receita prevista×realizada e despesa orçada×empenhada por município | siconfi | 2025 | há 37d | em dia |
| Acompanhamento por função (intra-anual) — orçado×realizado por função até o bimestre vigente (RREO Anexo 02 parcial) | siconfi | 2025 | há 37d | em dia |
| CNPJs do governo municipal (SICONFI+órgãos+RPPS) | siconfi | 2025 | há 37d | em dia |
| Despesa por subfunção (RREO an.2 — drill) | siconfi | 2025 | há 4h | pendente |
| Finanças (SICONFI RREO an.1/2) | siconfi | 2025 | há 17d | em dia |
| Metas Fiscais LDO (RREO an.6) | siconfi | 2025 | há 4h | pendente |
| MSC ancorada ao RREO — despesa empenhada por natureza e fonte (forma da MSC × total exato do RREO; reconcilia por construção) | siconfi | 2025 | há 37d | em dia |
| Receitas detalhadas (ICMS/FPM/IPTU/FUNDEB — RREO an.3) | siconfi | 2025 | há 4h | pendente |
| Pessoal/DCL (RGF) | siconfi | 2025 | há 26d | em dia |
| Previdência RPPS (RREO Anexo 04) | siconfi | 2025 | há 4h | pendente |
| Educação/RCL (RREO an.14/3) | siconfi | 2025 | há 4h | pendente |
| Salário-Educação por município (SICONFI DCA) | siconfi | 2025 | há 36d | em dia |
| Estatísticas vitais por município (IBGE Registro Civil — nascidos/óbitos, série) | sidra | 2024 | há 40d | em dia |
| Produção agropecuária (PAM/PPM) + empresas (CEMPRE) por município (IBGE SIDRA) | sidra | — | há 36d | em dia |
| Vítimas de crimes violentos letais por município (SINESP/MJSP, dados abertos) | sinesp | — | há 71d | em dia |
| Catálogo de Ações Orçamentárias Federais (SIOP dados abertos) — o que emenda financia por setor; cruza com acao_orcamentaria da indicação | siop | 2025 | há 36d | em dia |
| Saúde ASPS (SIOPS) | siops | 2025 | há 4h | pendente |
| Indicadores Previne + ISF (SISAB indicadorPainel — 10 quadrimestres) | sisab | 2025 | há 36d | em dia |
| Produção da APS (SISAB — fichas aprovadas, série mensal 2021+) | sisab | 2025 | há 11d | em dia |
| SNIS Água/Esgoto por município e prestador (atendimento, perdas, tratamento) — app Ministério das Cidades via Playwright; state-agnostic (UF/ANO) | snis | 2025 | há 36d | em dia |
| CAPAG capacidade de pagamento por município (STN/Tesouro) | tesouro | — | há 4h | pendente |
| Regularidade fiscal CAUC/CADIN (Tesouro) | tesouro | — | há 1d | em dia |
| Ranking da Qualidade da Informação Fiscal (Tesouro) por município | tesouro | 2025 | há 36d | em dia |
| Transferências da União por município, MENSAL (FPM/FUNDEB/ITR/Lei Kandir/CIDE/FEX/IOF/LC176) — CSV oficial STN/Tesouro Transparente; NACIONAL, state-agnostic (UF env) | tesouro | 2025 | há 6d | em dia |
| Precatórios por município (estoque e quantidade) — API do TJSC, Regime Especial de Precatórios; replicável por UF (CNJ Res. 303) | tjsc | 2025 | há 4h | pendente |
| Assistência social COMPLETA (MDS MI Social): série anual de repasse FNAS 2005→ + CadÚnico + Bolsa Família | transferegov | 2025 | há 6d | em dia |
| Convênios e contratos de repasse por município (SICONV/Transferegov, repositório detru — proposta+convenio) | transferegov | 2025 | há 47d | pendente |
| Emendas — INDICAÇÃO (SICONV/Transferegov, repositório detru: parlamentar, impositivo, valor destinado) | transferegov | 2025 | há 5d | em dia |
| Emendas — EXECUÇÃO orçamentária federal (Portal da Transparência: empenhado×pago → recurso na mesa) | transferegov | 2026 | há 4h | pendente |
| Elegibilidade dos programas (Transferegov: quem pode captar cada programa — base do casamento oportunidade×necessidade) | transferegov | 2025 | há 5d | em dia |
| Catálogo de programas Transferegov — gestão ágil (fundoafundo/programa_gestao_agil); complementa o catálogo unificado de 335 programas | transferegov | 2025 | há 4h | pendente |
| Programas federais curados de saúde/educação (Novo PAC, Requalifica UBS, Proinfância — casamento com carência; FNS/FNDE sem feed) | transferegov | 2025 | há 4h | pendente |
| Radar de Captação — programas + planos (Transferegov fundo a fundo, API viva) | transferegov | 2025 | há 4h | pendente |
| Assistência social / FNAS por município (MDS · MI Social/CadSUAS: CRAS, CREAS — déficit p/ casamento) | transferegov | 2025 | há 4h | pendente |
...
- `/api/sicro-precos/[termo]`
- `/api/siesc-precos/[termo]`
- `/api/sinapi-precos/[termo]`
...
- status: **ok** · registros suspeitos (excluídos): 6 · sobrepreço unitário: 19291
