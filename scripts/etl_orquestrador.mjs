...
const FONTES = [
  ...
  { id: "suas", label: "Assistência social / FNAS por município (MDS · MI Social/CadSUAS: CRAS, CREAS, repasse — déficit p/ casamento)", api: "transferegov", script: "scripts/ingest_suas_sc.mjs", env: {},
