  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-blue-200 bg-gradient-to-br from-blue-50 to-indigo-50 p-5">
        <div className="flex items-center gap-1.5 text-sm font-semibold text-blue-700"><GraduationCap aria-hidden className="h-4 w-4" /> Educação — gasto × resultado ({n1(d.pop)} hab · grupo {d.grupo})</div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className={`rounded-xl border p-4 ${mdeOk === false ? "border-amber-200 bg-amber-50" : "border-slate-200 bg-white"}`}>
          <div className="flex items-center gap-1.5 text-xs text-slate-500"><BookOpen aria-hidden className="h-3.5 w-3.5" /> Aplicação em Educação (MDE)</div>
        ...
        <div className={`rounded-xl border p-4 ${fundebOk === false ? "border-amber-200 bg-amber-50" : "border-slate-200 bg-white"}`}>
          <div className="flex items-center gap-1.5 text-xs text-slate-500"><BookOpen aria-hidden className="h-3.5 w-3.5" /> FUNDEB em remuneração</div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-1.5 text-xs text-slate-500"><GraduationCap aria-hidden className="h-3.5 w-3.5" /> Taxa de alfabetização</div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-1.5 text-xs text-slate-500"><TrendingUp aria-hidden className="h-3.5 w-3.5" /> PIB per capita (contexto)</div>
