  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-teal-200 bg-gradient-to-br from-teal-50 to-emerald-50 p-5">
        <div className="flex items-center gap-1.5 text-sm font-semibold text-teal-700"><HeartPulse aria-hidden className="h-4 w-4" /> Saúde — gasto × rede × população ({n1(d.pop)} hab · grupo {d.grupo})</div>
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div className={`rounded-xl border p-4 ${gastoOk === false ? "border-amber-200 bg-amber-50" : "border-slate-200 bg-white"}`}>
          <div className="flex items-center gap-1.5 text-xs text-slate-500"><Activity aria-hidden className="h-3.5 w-3.5" /> Gasto em saúde (<Termo k="ASPS" />)</div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-1.5 text-xs text-slate-500"><Building2 aria-hidden className="h-3.5 w-3.5" /> Estabelecimentos / mil hab</div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-1.5 text-xs text-slate-500"><Stethoscope aria-hidden className="h-3.5 w-3.5" /> Unidades SUS / mil hab</div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <div className="flex items-center gap-1.5 text-xs text-slate-500"><Building2 aria-hidden className="h-3.5 w-3.5" /> Atenção hospitalar</div>
      ...
      {d.transfSaudeValor != null && (
        <div className="rounded-xl border border-slate-200 bg-white p-4 text-sm">
          <div className="flex items-center gap-1.5 text-xs font-semibold text-slate-700"><Database aria-hidden className="h-3.5 w-3.5 text-teal-600" /> De onde vem o dinheiro da saúde (repasse federal SUS)</div>
      ...
      {fns && fns.total > 0 && (
        <div className="rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-teal-50 p-5">
          <div className="flex items-center gap-1.5 text-sm font-semibold text-emerald-800"><Database aria-hidden className="h-4 w-4" /> Repasses federais do FNS por bloco ({fns.ano})</div>
      ...
      {d.popIndigena != null && d.popIndigena > 0 && (
        <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm">
          <div className="flex items-center gap-1.5 text-xs font-semibold text-amber-800"><Users aria-hidden className="h-3.5 w-3.5" /> Saúde indígena — relevante neste município</div>
          <p className="mt-1 text-slate-700">
      ...
      <div>
        <h3 className="mb-2 flex items-center gap-1.5 text-sm font-semibold text-slate-800"><Activity aria-hidden className="h-4 w-4 text-rose-600" /> Produção (entrega ao cidadão)</h3>
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-xl border border-slate-200 bg-white p-4">
            <div className="flex items-center gap-1.5 text-xs text-slate-500"><Activity aria-hidden className="h-3.5 w-3.5" /> Internações / mil hab (SIH)</div>
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-4">
            <div className="flex items-center gap-1.5 text-xs text-slate-500"><Activity aria-hidden className="h-3.5 w-3.5" /> Procedimentos ambulatoriais / hab (SIA)</div>
      ...
      {previne && previne.indicadores.length > 0 && (
        <div>
          <h3 className="mb-2 flex items-center gap-1.5 text-sm font-semibold text-slate-800"><Stethoscope aria-hidden className="h-4 w-4 text-indigo-600" /> Atenção Primária — Previne Brasil ({previne.competencia})</h3>
