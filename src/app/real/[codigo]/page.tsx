...
export default async function RealEntePage({ params }: { params: Promise<{ codigo: string }> }) {
  ...
  if (saude) {
    ...
    tabs.push({ id: "saude", label: "Saúde — visão geral", content: (
      <>
        ...
        <div className="mt-4"><AnaliseSaude previne={previne} fns={fns} saude={saude} nome={ente.nome} /></div>{finAps && <div className="mt-4"><FinanciamentoApsPanel d={finAps} /></div>}
  ...
  if (assistSocial) {
    ...
    tabs.push({ id: "assistencia", label: "Assistência — visão geral", content: <>
      ...
      {igdm && <div className="mt-4"><IgdmPanel d={igdm} /></div>}{quilombos && <div className="mt-4"><QuilombosPanel d={quilombos} /></div>}
