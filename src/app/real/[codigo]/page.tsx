      ...
      <main className="mx-auto max-w-7xl space-y-6 px-4 py-6 lg:px-8">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5">
          ...
          <LinhasFinanceiras
            ...
            linhas={[
              { key: "receita", label: "Receita arrecadada", cor: "#0f766e" },
              { key: "despesa", label: "Despesa empenhada", cor: "#e11d48" },
            ]}
          />
        </section>
        ...
        {serie.some((s) => s.saude > 0) && (
          <section className="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <LinhasFinanceiras
              data={serie as unknown as Record<string, number>[]}
              linhas={[
                { key: "saude", label: "Saúde", cor: "#0891b2" },
                { key: "educacao", label: "Educação", cor: "#2563eb" },
                { key: "infraestrutura", label: "Infraestrutura", cor: "#7c3aed" },
                { key: "assistencia", label: "Assistência", cor: "#f59e0b" },
              ]}
            />
          </section>
        )}

        {/* Composições do ano mais recente */}
        ...
        {/* LOA — dotação × execução por função */}
        {funcData.length > 0 && (
          <section className="rounded-2xl border border-slate-200 bg-white p-5">
        ...
        <TransferenciasSCSection codigo={ente.cod_ibge} />
